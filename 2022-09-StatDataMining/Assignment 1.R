...
library(lmtest)
library(stargazer)
orig_sales <- import("HuntersGreenHomeSales.xlsx")
...
corrplot(salescorrmatrix, type="upper", order = "hclust", tl.col = "black", tl.srt = 45)
...
plot(adom3b, lwd=2, col="darkblue")
