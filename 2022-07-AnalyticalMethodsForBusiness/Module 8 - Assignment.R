...
library(rio)
library(car)
allcars=import("Module 8 Assignment Data.xlsx")
...
par(mfrow=c(1,2))
boxplot(asking.price,pch=19,col="steelblue",main="Asking Price by Cylinders",data=samplecars)
boxplot(asking.price~cylinders,pch=19,col="steelblue",main="Asking Price Split by Cylinders",data=samplecars)
par(mfrow=c(1,1))
